...
// PosttestParams contains all the bound params for the posttest operation
...
func (o *PosttestParams) bindEnum(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PosttestParams) validateEnum(formats strfmt.Registry) error {
...
func (o *PosttestParams) bindNum(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PosttestParams) bindStr(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
