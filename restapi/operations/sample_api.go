...
func NewSampleAPI(spec *loads.Document) *SampleAPI {
	return &SampleAPI{
		...
		GettestGettestHandler: gettest.GettestHandlerFunc(func(params gettest.GettestParams) middleware.Responder {
		...
		PosttestPosttestHandler: posttest.PosttestHandlerFunc(func(params posttest.PosttestParams) middleware.Responder {
...
type SampleAPI struct {
	...
	// GettestGettestHandler sets the operation handler for the gettest operation
	GettestGettestHandler gettest.GettestHandler
	// PosttestPosttestHandler sets the operation handler for the posttest operation
	PosttestPosttestHandler posttest.PosttestHandler
...
func (o *SampleAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *SampleAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}
...
func (o *SampleAPI) Validate() error {
	...
	if o.GettestGettestHandler == nil {
		unregistered = append(unregistered, "gettest.GettestHandler")
	}
	if o.PosttestPosttestHandler == nil {
		unregistered = append(unregistered, "posttest.PosttestHandler")
	}
...
func (o *SampleAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/gettest"] = gettest.NewGettest(o.context, o.GettestGettestHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/posttest"] = posttest.NewPosttest(o.context, o.PosttestPosttestHandler)
}
